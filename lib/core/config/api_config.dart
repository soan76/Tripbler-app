...
class ApiConfig {
  ...
  static Uri get authFindIdSendCodeUri {
    return Uri.parse(baseUrl).replace(path: authFindIdSendCodePath);
  }
  ...
  static Uri get usersMeGoogleLinkUri {
    return Uri.parse(baseUrl).replace(path: usersMeGoogleLinkPath);
  }
