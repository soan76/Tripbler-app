...
/// true = dark mode
/// false = light mode
- (void)setMapColorScheme:(BOOL)isDarkMode error:(FlutterError *_Nullable *_Nonnull)error;
...
- (void)createViewType:(nullable FGMPlatformMapViewCreationParams *)type error:(FlutterError *_Nullable *_Nonnull)error;
@end

extern void SetUpFGMMapsPlatformViewApi(id<FlutterBinaryMessenger> binaryMessenger, NSObject<FGMMapsPlatformViewApi> *_Nullable api);

extern void SetUpFGMMapsPlatformViewApiWithSuffix(id<FlutterBinaryMessenger> binaryMessenger, NSObject<FGMMapsPlatformViewApi> *_Nullable api, NSString *messageChannelSuffix);
